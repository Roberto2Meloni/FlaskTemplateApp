"""
Content Routes für ToDo_Ultimate
...
def dashboard():
    ...
    if is_ajax_request():
        return render_template(
            "_custom/content/ToDo_Ultimate_dashboard.html",
            user=current_user,
            config=config,
            app_config=app_config,
        )
    ...
    return render_template(
        "_base/ToDo_Ultimate.html",  # ✅ Haupt-Template
        user=current_user,
        config=config,
...
def page_01():
    ...
    if is_ajax_request():
        return render_template(
            "_custom/content/ToDo_Ultimate_page_01.html",
            user=current_user,
            config=config,
            app_config=app_config,
        )
...
def page_02():
    ...
    if is_ajax_request():
        return render_template(
            "_custom/content/ToDo_Ultimate_page_02.html",
            user=current_user,
            config=config,
            app_config=app_config,
        )

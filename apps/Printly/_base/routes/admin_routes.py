...
# Import aus Parent Package (Printly/__init__.py)
...
def app_info():
    ...
    if is_ajax_request():
        return render_template(
            "_base/admin/Printly_admin_info.html",
            user=current_user,
            config=app_config,
            app_config=app_config,
        )
...
def app_settings_config():
    ...
    if is_ajax_request():
        return render_template(
            "_base/admin/Printly_admin_config.html",
            user=current_user,
            config=app_config,
...
def app_settings_style():
    ...
    if is_ajax_request():
        return render_template(
            "_base/admin/Printly_admin_style.html",
            user=current_user,
            config=app_config,
            app_config_dict=app_config_dict,
            app_config=app_config,
...
def app_settings_sockets():
    ...
    if is_ajax_request():
        return render_template(
            "_base/admin/Printly_admin_sockets.html",
            user=current_user,
            config=app_config,
            app_config=app_config,
...
def app_settings_tasks():
    ...
    if is_ajax_request():
        return render_template(
            "_base/admin/Printly_admin_task.html",
            user=current_user,
            tasks=tasks,
            app_config=app_config,
        )
...
def app_settings_logs():
    ...
    if is_ajax_request():
        return render_template(
            "_base/admin/Printly_admin_logs.html",
            user=current_user,
            config=app_config,
            app_logs=app_logs,
            log_stats=log_stats,
...
def app_settings_backup_and_restore():
    ...
    if is_ajax_request():
        return render_template(
            "_base/admin/Printly_admin_backup_and_restore.html",
            user=current_user,
            config=app_config,
            app_config=app_config,
        )
